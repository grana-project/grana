...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " granacoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  granacoin-tx [options] <hex-tx> [commands]  Update hex-encoded granacoin transaction\n" +
            "or:     granacoin-tx [options] -create [commands]   Create hex-encoded granacoin transaction\n" +
            "\n";
