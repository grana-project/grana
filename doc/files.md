...
* granacoin.conf: contains configuration settings for granacoind or granacoin-qt
* granacoind.pid: stores the process id of granacoind while running
...
* debug.log: contains debug information and general logging generated by granacoind or granacoin-qt
