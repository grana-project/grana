# Support for Output Descriptors in Granacoin Core

Since Granacoin Core v0.17, there is support for Output Descriptors in the
...
- Segwit addresses (bech32, of the form `grana1...`, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Granacoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Granacoin Core wallets, a convenience function `combo` is
